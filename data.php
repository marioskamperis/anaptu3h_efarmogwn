...
if ( ! isset($_SESSION['user'])) {
	header("location: lobgin.php"); // Redirecting To Other Page
}
...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="index2.html" class="logo">
			<img src="dist/img/logo_small.png" class="logo" alt="User Image">
		</a>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				<li class="header">ΚΥΡΙΟ ΜΕΝΟΥ</li>
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a href="#">Πίνακες</a></li>
				<li class="active">Πίνακες Εισιτηρίων</li>
			</ol>
		</section>
...
<script>
	$(function ()
	{
		...
		{
			var ticket_number = e.target.id;
			console.log(ticket_number);

			$.ajax({
				method: "POST",
				url: "serve_ticket.php",
